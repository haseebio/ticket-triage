...
const FAQS = [
  ...
  ['Is this a production tool or a demo?', 'It\u2019s a fully working portfolio project — real database, real AI integration, real deployment — built to demonstrate a complete stack rather than for production support use.'],
    ...
    <div className="min-h-screen bg-paper">
      ...
      <main className="mx-auto max-w-2xl px-4 pb-20">
        ...
        <div className="mb-14 rounded-2xl border border-primary/15 bg-gradient-to-br from-primary-soft/40 to-secondary/10 p-8">
          <h2 className="mb-3 text-base font-semibold text-ink">Why it was built</h2>
          <p className="text-sm leading-relaxed text-fog">
            This project exists to bring SQL, Docker, CI/CD, and automated testing into one
            build alongside a genuine AI-integration feature — the kind of full-stack range a
            resume line can{'\u2019'}t show on its own. It{'\u2019'}s a working portfolio piece, built and
            deployed end to end rather than left as a local demo.
          </p>
        </div>
